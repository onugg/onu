...
var eventEmitFunction: Function = eventEmitter({brokerUrl: `${process.env.KNATIVE_BROKER_URL!}${process.env.KUBERNETES_NAMESPACE!}/database`}).emitEvent
  ...
  model: {
    ...
    discordMember: {
      async createIfNotExistsAndEmitEvent(discordMemberCreateArgs: Prisma.DiscordMemberCreateArgs) {
        return extensions.discord.member.createIfNotExists(eventEmitFunction, discordMemberCreateArgs)
      },
      async deleteIfExistsAndEmitEvent(discordMemberDeleteArgs: Prisma.DiscordMemberDeleteArgs) {
        return extensions.discord.member.deleteIfExists(eventEmitFunction, discordMemberDeleteArgs)
      }
    },
    discordUser: {
      async createIfNotExistsAndEmitEvent(discordUserUpsertArgs: Prisma.DiscordUserUpsertArgs) {
        return extensions.discord.user.createOrUpdateIfNotExists(eventEmitFunction, discordUserUpsertArgs)
      },
      async deleteIfExistsAndEmitEvent(discordUserDeleteArgs: Prisma.DiscordUserDeleteArgs) {
        return extensions.discord.user.deleteIfExists(eventEmitFunction, discordUserDeleteArgs)
      }
    },
    discordGuild: {
      async createIfNotExistsAndEmitEvent(discordGuildUpsertArts: Prisma.DiscordGuildUpsertArgs) {
        return extensions.discord.guild.createOfNotExistsOrUpdateAndEmitEvent(eventEmitFunction, discordGuildUpsertArts)
      },
      async deleteIfExistsAndEmitEvent(discordGuildDeleteArgs: Prisma.DiscordGuildDeleteArgs) {
        return extensions.discord.guild.deleteIfExists(eventEmitFunction, discordGuildDeleteArgs)
      }
    },
    ...
    community: {
      async createIfNotExistsAndEmitEvent(communityCreateArgs: Prisma.CommunityCreateArgs) {
        return extensions.main.community.createAndEmitEvent(eventEmitFunction, communityCreateArgs)
      }
    },
    ...
    memberQuestRecord: {
      async updateAndEmitLevelUpEvent(memberQuestRecordUpdateArgs: Prisma.MemberQuestRecordUpdateArgs) {
        return extensions.quests.memberQuestRecord.updateAndEmitLevelUpEvent(eventEmitFunction, memberQuestRecordUpdateArgs)
      }
    }/*,
