...
const SearchBar: React.FC = () => {
  return (
    <div className="relative z-10 my-12 mx-12 ">
      <div className="grid grid-cols-4 justify-center md:mx-24 2xl:mx-72">
        <div className="relative col-span-3 flex-row">
        ...
        <div className="relative col-span-1 flex flex-row justify-center gap-x-5">
          <button className="flex rounded-md border border-neutral-100 bg-neutral-100 py-2 px-4 text-sm font-medium text-neutral-900 duration-300 hover:scale-110 hover:bg-black hover:text-neutral-100 focus:border-neutral-100 focus:bg-black focus:text-neutral-100">
      ...
      <div className=" grid grid-cols-1 justify-center md:mx-24 md:grid-cols-3 md:gap-x-8 2xl:mx-72 ">
        {OwnedCommunitiesSample.map((community) => (
          <div key={community.name}>
            ...
            <div className="my-4 mx-1 flex justify-between font-medium">
